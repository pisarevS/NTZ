...
namespace Modeling
{
    class Expression
    {
        ...
        private String InsertZero(String input)
        {
            ...
            else if (input.Contains("-") && input.IndexOf("-") != 0)
            {
        ...
        static private float Counting(string input)
        {
            ...
            Stack<float> temp = new Stack<float>(); //Dhtvtyysq стек для решения
            ...
            for (int i = 0; i < input.Length; i++) //Для каждого символа в строке
            {
                ...
                if (Char.IsDigit(input[i]))
                {
                    ...
                    temp.Push(float.Parse(a)); //Записываем в стек
                    i--;
                }
                else if (IsOperator(input[i])) //Если символ - оператор
                {
                    ...
                    switch (input[i]) //И производим над ними действие, согласно оператору
                    {
                        ...
                        case '*': result = b * a; break;
                        case '/': result = b / a; break;
                        case '^': result = float.Parse(Math.Pow(float.Parse(b.ToString()), float.Parse(a.ToString())).ToString()); break;
                    }
